...
Полный цикл сборки и развертывания ML-сервиса: MLflow, Airflow, LakeFS, JupyterHub, ML-сервис, Prometheus/Grafana, Kubernetes, Helm, MLflow Prompt Storage.

## Структура проекта

```
Final/
├── mlflow/          # Этап 1: MLflow + PostgreSQL
├── airflow/         # Этап 2: Airflow
├── lakefs/         # Этап 3: LakeFS + MinIO
├── jupyterhub/     # Этап 4: JupyterHub
├── ml-service/     # Этап 5: ML-сервис (FastAPI)
├── monitoring/     # Этап 6: Prometheus + Grafana
├── k8s/            # Этап 7: Kubernetes манифесты
├── helm/            # Этап 8: Helm chart
└── docker-compose.full.yaml  # ML-сервис + мониторинг для проверки
```
